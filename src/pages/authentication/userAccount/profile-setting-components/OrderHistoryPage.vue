<template>
    <section >
        ...
        <div class="myOrder">
            ...
            <div class="category">
                <div class="state">
                    <button class="order" @click="changeColor('All orders')" :style="{backgroundColor: activeButton === 'All orders' ? '#E5E5E5' : '#B4AEAE'}">All orders</button>
                    <button class="ship" @click="changeColor('Shipped')" :style="{backgroundColor: activeButton === 'Shipped' ? '#E5E5E5' : '#B4AEAE'}">Shipped</button>
                    <button class="nship" @click="changeColor('Not yet shipped')" :style="{backgroundColor: activeButton === 'Not yet shipped' ? '#E5E5E5' : '#B4AEAE'}">Not yet shipped</button>
                </div>
            </div>
            <div class="orderList">
                <div class="content">
<div class="rate" v-if="showRate">
                        <div class="yes" @click="showRate = true">
