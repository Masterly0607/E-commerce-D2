<template>
    <div class="history">
        ...
        <div class="myOrder">
            ...
            <div class="category">
                <div class="state">
                    <button class="order" @click="changeColor('Orders')"  :style="{backgroundColor: activeButton === 'Orders' ? '#E5E5E5' : '#B4AEAE'}">Orders</button>
            ...
            <div class="orderList">
                <div class="head">
                    ...
                    <p>Total</p>
                    <p>Ship to</p>
                    <p>Order: #123-1234556-234566</p>
                    <p>July 5, 2024</p>
                    <p>$29</p>
                    <p>Christ Joden</p>
                    <div class="viewOrder">
                        <button class="view">View order detail</button>
                        <p>|</p>
                ...
                <div class="content">
                    ...
                    <div class="productList">
                        <div class="product" v-for="product in products" :key="product.name">
                            <div class="status">
                                <h3 class="date">Delivered {{ product.date }}</h3>
                                <div class="delivered">Your package was delivered. It was handled directly to a resident.</div>
                            </div>
                            <div class="productInfo">
                                <img class="productImg" :src="getImagepath(product.image)" :alt="product.name" />
                                <div class="productDescription">
                                    <div class="productTitle">{{ product.name }}</div>
                                    <div class="return">Return or Replace items: Eligible through {{ product.lastDate }} </div>
                                    <div class="buttons">
                                        <button class="again">
